...
module AngularRailsTemplatesSly
  class Engine < ::Rails::Engine
    ...
    initializer 'angular-rails-templates-sly', group: :all  do |app|
      if app.config.assets
        ...
        app.assets.register_engine '.html', AngularRailsTemplatesSly::Template
      end
